...
hoistedDependencies:
  ...
  /@types/ws/8.18.1:
    '@types/ws': private
  /@typescript-eslint/eslint-plugin/8.56.1(@typescript-eslint/parser@8.56.1)(eslint@9.39.3)(typescript@5.9.3):
  ...
  /eslint-plugin-prettier/5.5.5(eslint-config-prettier@10.1.8)(eslint@9.39.3)(prettier@3.8.1):
...
pendingBuilds: []
prunedAt: Thu, 05 Mar 2026 22:47:13 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
